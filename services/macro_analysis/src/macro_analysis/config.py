...
class MacroAnalysisSettings(BaseSettings):
    """Settings for Macro Analysis service."""

    model_config = SettingsConfigDict(
        env_prefix="MACRO_ANALYSIS_",
        env_file=".env",
    ...
    # Processing
    max_retries: int = 1
    history_months: int = 12  # Fetch 12 months of history


settings = MacroAnalysisSettings()
